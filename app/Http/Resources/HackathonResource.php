...
class HackathonResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'cover_image' => $this->banner_image,
            'image' => $this->banner_image ? asset('storage/'.$this->banner_image) : null,
            'image_url' => $this->banner_image ? asset('storage/'.$this->banner_image) : null,
